...
Public Class AdmitStudent
    ...
    Private Sub AdmitStd_Click(sender As Object, e As EventArgs) Handles AdmitStd.Click
        ...
        cmd.Parameters.Add(New OleDbParameter("CourseId", CType(ComboBox1.SelectedIndex + 1, Integer)))
        cmd.Parameters.Add(New OleDbParameter("MaxCredit", CType(maxCredits, Integer)))
